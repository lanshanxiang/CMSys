...
<body>
	<nav class="breadcrumb">
		...
		小区管理 <span class="c-gray en">&gt;</span> 小区信息 <a
					...
					.prompt(
							...
							function(pass, index) {
								...
								if (pass == "admin") {
									...
									$
											.ajax({
												url : "${pageContext.request.contextPath}/VillageInfoBeanServlet?op=deleteVillageInfoBean",//url地址
												type : "post",
												data : {
													"villageId" : $(obj)
															.parents("tr")
					...
					function() {
						...
						layer
								.open({
									...
									shade : 0.4,
									title : '编辑小区信息', //显示的标题
									content : 'village-update.jsp', //很多种写法 其中之一直接写目标窗口(要弹出来窗口)
  ...
  .paginate_button{box-sizing:content-box}
	...
	<script>
		...
		employee.requestUrl = {
			queryList : employee.url + "CMSys/VillageInfoBeanServlet" //数据是从servlet一侧返回的 json格式
		};
