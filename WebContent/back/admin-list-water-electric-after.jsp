...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 费用管理 <span class="c-gray en">&gt;</span> 物业缴费(已缴费) <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
...
<script>
    ...
    employee.requestUrl = {
        queryList:employee.url+"CMSys/PaymentServlet?op=after"  //数据是从servlet一侧返回的 json格式
    };
