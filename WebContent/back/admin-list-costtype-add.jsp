		...
		<form class="form form-horizontal"
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="固定类" placeholder=""
						id="ctName" name="ctName">
				</div>
			</div>
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" placeholder="" value="固定类指每月固定的费用"
	...
	<script type="text/javascript">
		$(function() {
			...
			$("#btnAdd").click(function(){
				//ajax请求
				$.ajax({
					url : "${pageContext.request.contextPath}/CostTypeServlet?op=add",//url地址
					type : "post",
					data : {
						"ctName" : $('#ctName').val(),
						"extent" : $('#extent').val()
