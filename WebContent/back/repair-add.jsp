	...
	<article class="cl pd-20">
		<form class="form form-horizontal" id="form-member-add">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" placeholder="" value="维修有送东西喽"
			...
			$("#btnAdd")
					.click(
							function() {
								...
								$
										.ajax({
											url : "${pageContext.request.contextPath}/RepairBeanServlet?op=addRepairBean",//url地址
											type : "post",
											data : {
												"reportId" : $(
														'#reportId').val(),
												"injureReason" : $('#injureReason').val(),
												"repairUnit" : $('#repairUnit').val(),
