...
<body>
	<nav class="breadcrumb">
		...
		用户管理 <span class="c-gray en">&gt;</span> 用户信息列表 <a
		...
		<article class="cl pd-20">
			...
			<div class="cl pd-5 bg-1 bk-gray mt-20">
				<span class="l"><a href="javascript:;" id="plsc"
					...
					onclick="member_add('添加用户','user-add.jsp','','510')"
				...
				<table id="example"
					...
					<thead>
						<tr class="text-c">
							...
							<th>性别</th>
							<th>年龄</th>
							<th width="60px">住户编号</th>
							<th width="100px">住户姓名</th>
							<th>密保问题</th>
							<th>密保答案</th>
							<th>状态</th>
							<th>操作</th>
			...
			layer.prompt(
							...
							function(pass, index) {
								...
								if (pass == "admin") {
									...
									$
											.ajax({
												url : "${pageContext.request.contextPath}/UserBeanServlet?op=deleteUserBean",//url地址
												type : "post",
												data : {
													"userId" : $(obj)
															.parents("tr")
					...
					function() {
						...
						layer
								.open({
									...
									shade : 0.4,
									title : '编辑用户信息', //显示的标题
									content : 'user-update.jsp', //很多种写法 其中之一直接写目标窗口(要弹出来窗口)
  ...
  .paginate_button{box-sizing:content-box}
	...
	<script>
		...
		employee.requestUrl = {
			queryList : employee.url + "CMSys/UserBeanServlet" //数据是从servlet一侧返回的 json格式
		};
