		...
		<form class="form form-horizontal" id="form-member-add">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" placeholder="" value="马桶"
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" placeholder=""
						value="小兰" name="reportName" id="reportName">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"><span
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" placeholder="" value="报修有奖"
			...
			$("#btnAdd")
					.click(
							function() {
								...
								$
										.ajax({
											url : "${pageContext.request.contextPath}/ReportBeanServlet?op=addReportBean",//url地址
											type : "post",
											data : {
												"equipment" : $(
														'#equipment').val(),
