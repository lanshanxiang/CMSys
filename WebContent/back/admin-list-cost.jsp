...
<div class="page-container">
	<article class="cl pd-20"> 
		<div class="text-c">
		        ...
		        费用名称：<input type="text" class="form-controlSearch input-text " placeholder="输入费用名称" data-column="2" id="col2_filter" style="width:100px;">
		    费用说明：<input type="text" class="form-controlSearch input-text " placeholder="输入费用说明" data-column="4" id="col4_filter" style="width:100px;">
		     费用类别编号：<input type="text" class="form-controlSearch input-text " placeholder="输入费用类别编号" data-column="5" id="col5_filter" style="width:100px;">
   		 计价单位：<input type="text" class="form-controlSearch input-text " placeholder="输入计价单位" data-column="6" id="col6_filter" style="width:100px;">
