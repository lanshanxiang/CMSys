		...
		<form class="form form-horizontal"
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="6543" placeholder=""
						id="conplyId" name="conplyId">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"><span
					class="c-red">*</span>投诉人姓名：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="6543" placeholder=""
						id="conplyName" name="conplyName">
				</div>
			</div>

			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"><span
					class="c-red">*</span>投诉问题：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="ttt" placeholder=""
						id="conplyQuestion" name="conplyQuestion">
				</div>
			</div>
			<!-- <div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"><span
					class="c-red">*</span>投诉时间：</label>
				<div class="formControls col-xs-8 col-sm-9">
			...
			<div class="row cl">
					<label for="conplyTime" class="form-label col-xs-4 col-sm-3"><span
					class="c-red">*</span>投诉时间：</label>
					<div class="form-label col-xs-4 col-sm-3">
						<input type="text" class="layui-input" id="conplyTime" name="conplyTime"
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" placeholder="" value="0"
						name="conplyPhone" id="conplyPhone">
				</div>
			</div>
			<div class="row cl">
				<label class="form-label col-xs-4 col-sm-3"><span
					class="c-red">*</span>是否处理：</label>
				<div class="formControls col-xs-8 col-sm-9">
					<select name="conplyStatus" id="conplyStatus">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" placeholder="" value="0"
						name="conplyRemark" id="conplyRemark">
				</div>
			</div>
	...
	<script type="text/javascript">
		$(function() {
			...
			$("#btnAdd").click(function(){
				//ajax请求
				$.ajax({
					url : "${pageContext.request.contextPath}/cs.do?op=updateComplain",//url地址
					type : "post",
					data : {
						"conplyId" : $('#conplyId').val(),
