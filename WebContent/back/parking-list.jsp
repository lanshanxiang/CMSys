...
<div class="page-container">
    ...
    使用状态：<input type="text" class="form-controlSearch input-text Wdate"   placeholder="输入车辆使用状态" data-column="4" id="col4_filter" style="width:100px;">
  ...
  $(function(){
	 ...
	 $(document).on("click",'.empedit',function()
	 {
		 var _this = $(this); //当前对象 编辑的超链接
	      ...
	      var arr = [];
	     for(var i = 2; i< data.length; i++){ //1 从1开始 从姓名开始
...
//            对第7列内容进行替换处理
            ...
            render: function (data, type, row, meta) {
                if (data == "0") {
                    return employee.property.a1;
                }else if (data == "1") {
                    return employee.property.a2;
                }else if (data == "2") {
                    return employee.property.a3;
                }
            }
        }, */
