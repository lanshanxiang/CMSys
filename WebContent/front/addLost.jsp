					...
					<div class="content w1150" id="content"
                        ...
                        <hr>
							<form class="form-horizontal" style="margin-left: 100px;">
								...
								<div class="form-group">
									<label for="lostDate" class="col-sm-2 control-label">请输入要捡到的时间</label>
									<div class="col-sm-6">
										<input type="text" class="layui-input" id="lostDate"
											name="lostDate" placeholder="请输入年月日">
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-6">
										<input type="tel" class="form-control" id="lostTel"
											name="lostTel" placeholder="您的联系人电话">
									</div>
								</div>
								<div class="form-group">
