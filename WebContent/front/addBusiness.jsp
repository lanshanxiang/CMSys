                        ...
                        <hr>
							<form class="form-horizontal" style="margin-left: 100px;">
								<div class="form-group">
									<label for="bName" class="col-sm-2 control-label">商家名称:</label>
									<div class="col-sm-6">
								...
								<div class="form-group">
									<label for="bPeopleName" class="col-sm-2 control-label">商家联系人:</label>
									<div class="col-sm-6">
										<input type="text" class="form-control" id="bPeopleName"
											name="bPeopleName" placeholder="">
									</div>
								</div>
								<div class="form-group">
									<label for="bTel" class="col-sm-2 control-label">商家联系电话:</label>
									<div class="col-sm-6">
										<input type="text" class="form-control" id="bTel"
											name="bTel" placeholder="">
									</div>
								</div>
								<div class="form-group">
									<div class="col-sm-offset-2 col-sm-2">
										<button style="width: 100px;" id="addBusiness" type="button"
