...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="front/css/templates/product/product.css?v=9efc496a">
    <script type="text/javascript"
    ...
    <script type="text/javascript" src="club/attachments/js/vendor/angular.min.js"></script>
    <script type="text/javascript">
...
<div class="g-header extend-m">
    ...
    <div class="m-header extend-m">
        ...
        <ul class="vertify-list">
            <li class="u-header-selectp">
                ...
                <div class="hover-select">
                                                                ...
                                                                <li><a href="/club/newclub/services?product_id=2">金蝶云&middot;星空</a></li>
                                                                                                                    <li><a href="/club/newclub/services?product_id=3">K/3 WISE</a></li>
            ...
            <li class="w-narrow">
                <a href="/club/newclub/identification">金蝶认证</a>
            </li>
            <li id="jycourse" class="w-narrow">
                <a href="/club/newclub/jycourse" target="_blank">顾问学院</a>
            </li>
            <li class="w-narrow">
                <a data-noLoginHref="http://www.yunxiangclub.com"
                   data-href="http://www.yunxiangclub.com/auth/login?redirect=http%3A%2F%2Fwww.yunxiangclub.com"
                   target="_blank" onclick="thirdPart(this)">云享俱乐部</a>
            </li>
        </ul>
...
<div class="g-content">
    ...
    <div class="g-in">
                <a class="u-prod-icon icon-cloud-w" data-to-href="/club/newclub/services?product_id=2" ></a>
                <ul id="m-prod-tab" class="m-prod-tab">
                        <li id="prod-tab-service"><a href="/club/newclub/services?product_id=2">服务</a></li>
                                    <li id="prod-tab-help"><a href="/club/newclub/helpIndex?product_id=2">知识</a></li>
                                    <li id="prod-tab-school"><a href="/club/newclub/school?product_id=2">课程</a></li>
                        <li id="prod-tab-forum"><a href="/forum.php?mod=forumdisplay&fid=748">论坛</a>
                <i class="icon-new-tab"></i>
            </li>
                        <li id="prod-tab-doc"><a href="https://open.kingdee.com/K3Cloud/WenKu/Index.aspx" target="_blank" rel="nofollow">文档</a></li>
                                </ul>

        <div id="m-header-search" class="m-header-search hide">
            <input id="u-headersearch-input" type="text" class="u-headersearch-input" placeholder="搜索你想要的课程" maxlength="32" >
            <div id="u-headersearch-btn" class="u-headersearch-btn"></div>
        </div>
                <div class="m-curr-prod">
...
<div class="g-prod-search">
    ...
    <div class="m-prod-search">
        <div class="search-input-area">
            <input id="search-input" type="text" placeholder="请输入您的问题" maxlength="32" >
            <button id="search-btn" >搜索</button>
            <input type="text" autocomplete="off" style="width: 1px; height: 1px; position: absolute; border: 0px; padding: 0px; opacity:0;"/>
        </div>
        <div id="search-input-list" class="search-input-list">
    ...
    <div class="links">
        <dl class="iblock">
            ...
            <div class="friendship_link">
                <dd>
                    <span>金蝶产品</span>
                    <a class="child1 link_kd" href="http://www.kingdee.com/products/eas/"  target="_blank" data-href="https://api.kingdee.com/auth/user/onelogin?redirect_uri=http://www.kingdee.com/"
                    data-type="金蝶EAS">金蝶EAS</a>
                    <a class="child2 link_kd" href="http://www.kingdee.com/products/k3cloud/"  target="_blank" data-href="https://api.kingdee.com/auth/user/onelogin?redirect_uri=http://www.kingdee.com/"
                    data-type="金蝶K/3 Cloud" >金蝶云·星空</a>
                    <a class="child3 link_kd" href="http://www.kingdee.com/products/k3wise/"  target="_blank" data-href="https://api.kingdee.com/auth/user/onelogin?redirect_uri=http://www.kingdee.com/"
                    data-type="金蝶K/3 WISE" >金蝶K/3 WISE</a>
                    <a class="child4 link_kd"  href="http://www.kingdee.com/products/kis/"  target="_blank" data-href="https://api.kingdee.com/auth/user/onelogin?redirect_uri=http://www.kingdee.com/"
                    data-type="金蝶KIS系列" >金蝶KIS系列</a>
                    <a class="child5 yunpan" target="_blank" onclick="thirdPart(this)" data-href="https://pan.kingdee.com/sso/onetologin?redirect_uri=https%3a%2f%2fpan.kingdee.com%2f" href="https://pan.kingdee.com/sso/onetologin?redirect_uri=https%3a%2f%2fpan.kingdee.com%2f" data-type="云盘">金蝶企业云盘</a>
                    <a class="child6 link_kd" target="_blank" data-type="企业平台" onclick="thirdPart(this)" data-href="https://api.kingdee.com/auth/user/onelogin?redirect_uri=http://cloud.kingdee.com/qy" href="https://api.kingdee.com/auth/user/onelogin?redirect_uri=http://cloud.kingdee.com/qy" class="kd_cloud">金蝶云平台</a>
                    <a class="child7" href="http://kdweibo.com/home/?utm_source=&utm_medium="  target="_blank">云之家</a>
                    <a class="child8" href="http://www.jdy.com/"  target="_blank">精斗云</a>
                </dd>
                <dd class="second">
                    <span></span>
                    <a  class="child1 link_kd" href="http://www.ik3cloud.com/"  target="_blank" onclick="thirdPart(this)" data-href="https://api.kingdee.com/auth/user/onelogin?redirect_uri=http://www.ik3cloud.com/"
                    data-type="金蝶云">金蝶云</a>
...
<script type="text/javascript" src="/front/js/base/main.js?v=117dc66c"></script>
    ...
    <script type="text/javascript" src="/front/js/templates/product/product.js?v=233dec00"></script>
