...
<![endif]-->
	...
	<div class="g-content">
		...
		<div class="m-new-dynamic">
			...
			<hr>
			<ul class="new-dynamic-list" id="pay">
	...
	layui.use('flow', function(){
		  ...
		  flow.load({
		    ...
		    ,done: function(page, next){ //到达临界点（默认滚动触发），触发下一页
		      ...
		      $.ajax({
   			 url:"${pageContext.request.contextPath}/FrontPayServlet",
   			 type:"get",
   			 data:{
   				 "page":page
   			 },
   			 ...
   			 var array = JSON.parse(result);
		          layui.each(array, function(index, pay){
		        	  var text = "";
		        	  text += "<li class=\"new-dynamic-item\" style=\" width: 100%;\">";
		        	  text += "					<img style=\"width: 250px; height: 200px; float: left;\" src=\"img/1.png\" alt=\"\">";
		        	  text += "					<h3 style=\"display: inline; float: left; width: 900px; text-align: left;\">缴费人:"+pay.tenementName+"</h3>";
		        	  text += "					<h6 style=\"float: left; width: 900px; text-align: left;\">缴费时间："+pay.payTime+"</h6>";
		        	  text += "					<h4 style=\"display: inline; float: left; width: 900px; text-align: left;\">缴费金额："+pay.payMoney+"</h4>";
		        	  text += "					<h4 style=\"display: inline; float: left; width: 900px; text-align: left;\">缴费类型:"+pay.costName+"</h4>";
		        	  text += "			    </li>";
