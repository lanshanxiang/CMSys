                ...
                -->
					<div class="content w1150" id="content" style="margin-bottom: 50px;">
						<div class="content__article">
							...
							<div class="content__list" id="lost">
							</div>
						</div>
					</div>
		      ...
		      $.ajax({
		        ...
		        //假设你的列表返回在data集合中
		          ...
		          layui.each(array, function(index, lost){
		        	  var text = "";
		        	  text += "  <li class=\"new-dynamic-item\" style=\"margin-bottom: 200px; width: 280px; Float:left; margin:50px;\">";
		        	  text += "		        	  <a target=\"_blank\" >";
		        	  text += "		        	  <img src=\"img/1.png\"  style=\"width: 250px; height: 180px\">";
		        	  text += "		        	  <div class=\"news-subject\">物品："+lost.lostGood+"</div>";
		        	  text += "		        	  <div class=\"news-subject\">捡到时间："+lost.lostDate+"</div>";
		        	  text += "		        	  <div class=\"news-subject\">捡到地址："+lost.lostArea+"</div>";
		        	  text += "		        	  <div class=\"news-subject\">捡到者姓名："+lost.lostName+"</div>";
		        	  text += "		        	  <div class=\"news-subject\">捡到者电话："+lost.lostTel+"</div>";
		        	  text += "		        	  <div class=\"news-subject\">发布时间："+lost.sDate+"</div>";
		        	  text += "		        	  </a>";
		        	  text += "		        	  </li>"; 
