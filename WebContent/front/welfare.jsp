...
<![endif]-->
	...
	<div class="g-content">
		...
		<div class="m-new-dynamic">
			...
			<hr>
			<ul class="new-dynamic-list" id="welfare">
	...
	layui.use('flow', function(){
		  ...
		  flow.load({
		    ...
		    ,done: function(page, next){ //到达临界点（默认滚动触发），触发下一页
		      ...
		      $.ajax({
   			 url:"${pageContext.request.contextPath}/FrontWelfareServlet",
   			 type:"get",
   			 data:{
   				 "page":page
   			 },
   			 ...
   			 var array = JSON.parse(result);
		          layui.each(array, function(index, welfare){
		        	  var text = "";
		        	  text += "<li class=\"new-dynamic-item\" style=\" width: 100%;\">";
		        	  text += "					<img style=\"width: 250px; height: 200px; float: left;\" src=\"img/1.png\" alt=\"\">";
		        	  text += "					<h3 style=\"display: inline; float: left; width: 900px; text-align: left;\">福利标题:"+welfare.welfareTitle+"</h3>";
		        	  text += "					<h6 style=\"float: left; width: 900px; text-align: left;\">开始时间："+welfare.welfareDate+"</h6>";
		        	  text += "					<h4 style=\"display: inline; float: left; width: 900px; text-align: left;\">内容："+welfare.welfareContent+"</h4>";
		        	  text += "					<h4 style=\"display: inline; float: left; width: 900px; text-align: left;\">参与联系电话:"+welfare.welfareTel+"</h4>";
		        	  text += "			    </li>";
