                ...
                -->
					<div class="content w1150" id="content" style="margin-bottom: 50px;">
						<div class="content__article">
							...
							<div class="content__list" id="welfare">
		      ...
		      $.ajax({
		        ...
		        //假设你的列表返回在data集合中
		          ...
		          layui.each(array, function(index, welfare){
		        	  ...
		        	  text += "											<a";
		        	  text += "												href=\"http://sports.sina.com.cn/basketball/nba/2018-10-18/doc-ihmrasqr8710783.shtml?cre=tianyi&amp;mod=pcsptw&amp;loc=1&amp;r=97&amp;doct=0&amp;rfunc=29&amp;tj=none&amp;tr=97\"";
		        	  text += "												target=\"_blank\" node-type=\"sima-click-0\">福利标题:"+welfare.welfareTitle+"</a>";
		        	  text += "										</h3>";
		        	  text += "										<p class=\"ty-card-tip1\">福利内容："+welfare.welfareContent+"</p>";
		        	  text += "										<p class=\"ty-card-tip2 clearfix\">";
		        	  text += "											<span class=\"ty-card-tip2-i ty-card-time\">时间："+welfare.welfareDate+"</span><span";
		        	  text += "												class=\"ty-card-tip2-i ty-card-media\">联系电话："+welfare.welfareTel+"</span><span";
		        	  text += "												class=\"ty-card-tip2-i ty-card-tags\"><span";
		        	  text += "												class=\"ty-card-tag\" node-type=\"ty-card-tag\"><a";
		        	  text += "													href=\"//tags.sports.sina.com.cn/米罗蒂奇\" target=\"_blank\"></a></span><span";
		        	  text += "												class=\"ty-card-tag\" node-type=\"ty-card-tag\"><a";
