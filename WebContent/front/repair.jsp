...
<meta itemprop="image"
	content="http://clubimg.kingdee.com/club/attachments/school/images/imgupload/20170727quF8C1ruZPRzdTnh.png" />
...
<![endif]-->
	...
	<div class="g-content">
		...
		<div class="m-new-dynamic">
			<h1 style="font-size: 60px">维修记录！！</h1>
			<hr>
			<ul class="new-dynamic-list" id="repair">
	...
	layui.use('flow', function(){
		  ...
		  flow.load({
		    ...
		    ,done: function(page, next){ //到达临界点（默认滚动触发），触发下一页
		      ...
		      $.ajax({
   			 url:"${pageContext.request.contextPath}/FrontRepairBeanServlet",
   			 type:"get",
   			 data:{
   				 "page":page
   			 },
   			 ...
   			 var array = JSON.parse(result);
		          layui.each(array, function(index, repair){
		        	  var text = "";
		        	  text += "<li class=\"new-dynamic-item\" style=\" width: 100%;\">";
		        	  text += "					<img style=\"width: 250px; height: 200px; float: left;\" src=\"img/1.png\" alt=\"\">";
		        	  text += "					<h3 style=\"display: inline; float: left; width: 900px; text-align: left;\">损坏设备名称:"+repair.equipment+"</h3>";
		        	  text += "					<h6 style=\"float: left; width: 900px; text-align: left;\">维修时间："+repair.repairTime+"</h6>";
		        	  text += "					<h4 style=\"display: inline; float: left; width: 900px; text-align: left;\">损坏原因："+repair.injureReason+"</h4>";
		        	  text += "					<h4 style=\"display: inline; float: left; width: 900px; text-align: left;\">维修金额:"+repair.payment+"</h4>";
		        	  text += "					<h4 style=\"display: inline; float: left; width: 900px; text-align: left;\">维修单位："+repair.repairUnit+"</h4>";
		        	  text += "			    </li>";
