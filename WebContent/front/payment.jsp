				...
				<div class="col-md-12">
					<div class="content w1150" id="content" style="margin-bottom: 50px;">
						<div class="content__article">
							...
							<div class="content__list" id="payment">
		      ...
		      $.ajax({
		        ...
		        //假设你的列表返回在data集合中
		          ...
		          layui.each(array, function(index, pay){
		        	  ...
		        	  text += "											<a";
		        	  text += "												href=\"http://sports.sina.com.cn/basketball/nba/2018-10-18/doc-ihmrasqr8710783.shtml?cre=tianyi&amp;mod=pcsptw&amp;loc=1&amp;r=97&amp;doct=0&amp;rfunc=29&amp;tj=none&amp;tr=97\"";
		        	  text += "												target=\"_blank\" node-type=\"sima-click-0\">缴费人姓名:"+pay.tenementName+"</a>";
		        	  text += "										</h3>";
		        	  text += "										<p class=\"ty-card-tip1\">缴费类型："+pay.costName+"</p>";
		        	  text += "										<p class=\"ty-card-tip2 clearfix\">";
		        	  text += "											<span class=\"ty-card-tip2-i ty-card-time\">缴费金额："+pay.payMoney+"</span><span";
		        	  text += "												class=\"ty-card-tip2-i ty-card-media\">缴费时间："+pay.payTime+"</span><span";
