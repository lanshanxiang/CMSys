                ...
                -->
					<div class="content w1150" id="content" style="margin-bottom: 50px;">
						<div class="content__article">
							...
							<div class="content__list" id="Village">
							</div>
						</div>
					</div>
		      ...
		      $.ajax({
		        ...
		        //假设你的列表返回在data集合中
		          ...
		          layui.each(array, function(index, village){
		        	  ...
		        	  text += "		        	  <div class=\"news-subject\">小区名字："+village.villageName+"</div>";
		        	  text += "		        	  <div class=\"news-subject\">负责人："+village.linkman+"</div>";
		        	  text += "		        	  <div class=\"news-subject\">小区建立时间："+village.setUpTime+"</div>";
		        	  text += "		        	  <div class=\"news-subject\">占地面积："+village.floorArea+"</div>";
		        	  text += "		        	  <div class=\"news-subject\">建筑面积："+village.buildingArea+"</div>";
		        	  text += "		        	  <div class=\"news-subject\">车库面积："+village.garageArea+"</div>";
		        	  text += "		        	  <div class=\"news-subject\">车位数："+village.stallNum+"</div>";
		        	  text += "		        	  <div class=\"news-subject\">绿化面积："+village.greenArea+"</div>";
		        	  text += "		        	  <div class=\"news-subject\">位置说明："+village.location+"</div>";
		        	  text += "		        	  <div class=\"news-subject\">小区说明："+village.introduction+"</div>";
		        	  text += "		        	  </a>";
		        	  text += "		        	  </li>"; 
