		      ...
		      $.ajax({
		        ...
		        //假设你的列表返回在data集合中
		          ...
		          layui.each(array, function(index, repair){
		        	  ...
		        	  text += "											<a";
		        	  text += "												href=\"http://sports.sina.com.cn/basketball/nba/2018-10-18/doc-ihmrasqr8710783.shtml?cre=tianyi&amp;mod=pcsptw&amp;loc=1&amp;r=97&amp;doct=0&amp;rfunc=29&amp;tj=none&amp;tr=97\"";
		        	  text += "												target=\"_blank\" node-type=\"sima-click-0\">报修人:"+repair.reportName+"</a>";
		        	  text += "										</h3>";
		        	  text += "										<p class=\"ty-card-tip1\">损坏设备:"+repair.equipment+"    损坏问题："+repair.injureReason+"</p>";
		        	  text += "										<p class=\"ty-card-tip2 clearfix\">";
		        	  text += "											<span class=\"ty-card-tip2-i ty-card-time\">维修单位："+repair.repairUnit+"</span><span";
		        	  text += "												class=\"ty-card-tip2-i ty-card-media\">维修时间："+repair.repairTime+"</span><span";
		        	  text += "												class=\"ty-card-tip2-i ty-card-tags\"><span";
		        	  text += "												class=\"ty-card-tag\" node-type=\"ty-card-tag\"><a";
		        	  text += "													href=\"//tags.sports.sina.com.cn/米罗蒂奇\" target=\"_blank\">维修费用："+repair.payment+"</a></span><span";
		        	  text += "												class=\"ty-card-tag\" node-type=\"ty-card-tag\"><a";
