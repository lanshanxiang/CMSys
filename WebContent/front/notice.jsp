                ...
                -->
					<div class="content w1150" id="content" style="margin-bottom: 50px;">
						<div class="content__article">
							...
							<div class="content__list" id="notice">
	...
	layui.use('flow', function(){
		  ...
		  flow.load({
		    ...
		    ,done: function(page, next){ //到达临界点（默认滚动触发），触发下一页
		      ...
		      $.ajax({
     			 url:"${pageContext.request.contextPath}/FrontNoticeServlet",
     			 type:"get",
     			 data:{
     				 "page":page
     			 },
		        ...
		        //假设你的列表返回在data集合中
		          ...
		          layui.each(array, function(index, notice){
		        	  
		        	/*   var text = "";
		        	  text += "<li><span>2018-09-17</span>";
		        	  text += "									<a>[活动]</a>";
		        	  text += "									<a>"+active.activeContent+"</a>";
		        	  text += "								</li>"; */

		        	  
		        	  var text = "";
		        	  text += "                     <div class=\"news-list-bd\">";
		        	  text += "							<ul id=\"news-list-con\">";
		        	  text += "								<li><span>2018-09-18</span>";
		        	  text += "									<a >[公告]</a>";
		        	  text += "									<a>"+notice.contents+"</a>";
		        	  text += "								</li>";
		        	  text += "							</ul>";
		        	  text += "						</div>";
