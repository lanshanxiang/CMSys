...
public class BuildingBeanServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//增加功能
			...
			//将获取到的信息存储到实体类中
			BuildingBean bb=new BuildingBean(buildingName, face, buildArea, floorNum, height, buildTime, type, villageId, extent);
		...
		//修改功能
			...
			//将获取到的信息存储到实体类中
			BuildingBean bb=new BuildingBean(buildingName, face, buildArea, floorNum, height, buildTime, type, villageId, extent,buildingId);
			//再进行数据库交互，返回一个boolean类型的值
