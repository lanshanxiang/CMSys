...
public class ComplainServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//增加功能
			...
			//将获取到的信息存储到实体类中
			ComplainBean c=new ComplainBean(conplyName, conplyQuestion, conplyTime, conplyTel, conplyPhone, conplyStatus, conplyRemark);
		...
		//修改功能
			...
			//将获取到的信息存储到实体类中
			ComplainBean c=new ComplainBean(conplyName, conplyQuestion, conplyTime, conplyTel, conplyPhone, conplyStatus, conplyRemark,conplyId);
			//再进行数据库交互，返回一个boolean类型的值
